#ifndef _NUBOTSBALL_PLUGIN_HH_
#define _NUBOTSBALL_PLUGIN_HH_
...
namespace gazebo
{
	...
	public:
		...
		void Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
		{
			...
			std::cerr << "\nThe NUbots ball plugin is attached to model [" <<
				_model->GetName() << "]\n";
			...
			this->updateConnection = event::Events::ConnectWorldUpdateBegin(
				std::bind(&NUbotsBallPlugin::OnUpdate, this));
